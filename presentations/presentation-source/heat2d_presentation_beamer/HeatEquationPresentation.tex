...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{Screenshot from 2024-09-30 17-03-52.png}
   % \caption{Chunks deviding the domaing and the defined halo regions}
    \label{fig:enter-label}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{Screenshot from 2024-09-30 16-48-23.png}
   % \caption{Chunks deviding the domaing and the defined halo regions}
    \label{fig:enter-label}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{Screenshot from 2024-10-01 01-24-20.png}
   % \caption{Chunks deviding the domaing and the defined halo regions}
    \label{fig:enter-label}
\end{figure}
\end{frame}
