...
\begin{itemize}
    ...
    \item The workdiv for the borders-kernel would need larger extents but will only work on borders.    %\item Some threads other than the ones updating the border will do nothing when running Boundary kernel
\end{itemize}
